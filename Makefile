...
IMAGE = $(VENDOR)/php
VERSIONS=8.4-cli 8.4-fpm 8.4-apache 8.3-cli 8.3-fpm 8.3-apache 8.2-cli 8.2-fpm 8.2-apache 8.1-cli 8.1-fpm 8.1-apache 8.0-cli 8.0-fpm 8.0-apache 7.4-cli 7.4-fpm 7.4-apache 7.3-cli 7.3-fpm 7.3-apache 7.2-cli 7.2-fpm 7.2-apache 7.1-cli 7.1-fpm 7.1-apache 7.0-cli 7.0-fpm 7.0-apache 5.6-cli 5.6-fpm 5.6-apache
